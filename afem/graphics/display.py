...
from OCC.Core.AIS import (AIS_InteractiveContext, AIS_Shape, AIS_Shaded,
                      AIS_WireFrame)
from OCC.Core.Aspect import Aspect_DisplayConnection, Aspect_TOTP_LEFT_LOWER
...
from OCC.Core.MeshVS import (MeshVS_DA_DisplayNodes, MeshVS_DA_EdgeColor,
                         MeshVS_Mesh, MeshVS_MeshPrsBuilder)
from OCC.Core.Quantity import *

try:
    from OCC.Core.SMESH import SMESH_MeshVSLink, SMESH_Mesh, SMESH_subMesh
except ImportError:
    print('Warning: SMESH functions are not available')
    SMESH_MeshVSLink, SMESH_Mesh, SMESH_subMesh = None, None, None

from OCC.Core.TopoDS import TopoDS_Shape
from OCC.Core.V3d import V3d_Viewer
from OCC.Core.V3d import V3d_XposYnegZneg, V3d_XposYposZpos
from OCC.Core.V3d import V3d_Xneg, V3d_Xpos
from OCC.Core.V3d import V3d_Yneg, V3d_Ypos
from OCC.Core.V3d import V3d_Zneg, V3d_Zpos
...
class BasicViewer(wx.Frame):
    ...
    def _init(self):
        ...
        self._my_view.TriedronDisplay(Aspect_TOTP_LEFT_LOWER, self._black,
                                      0.08)
        self._my_view.SetProj(V3d_XposYposZpos)
    ...
    def _init_wind(self, fit, background):
        ...
        if self._my_view.IsEmpty():
            ...
            #else:
                #from OCC.Core.XwWindow import Xw_Window
    ...
    def _evt_char(self, e):
        if e.GetKeyCode() == ord('f'):
            ...
            self._my_view.SetProj(V3d_Zpos)
    ...
    def display_ais(self, ais_shape, update=True):
        ...
        :param OCC.Core.AIS.AIS_Shape ais_shape: The AIS shape.
    ...
    def view_bottom(self):
        ...
        :return: None.
        """
        self._my_view.SetProj(V3d_Zneg)
    ...
    def view_front(self):
        ...
        :return: None.
        """
        self._my_view.SetProj(V3d_Xneg)
    ...
    def view_rear(self):
        ...
        :return: None.
        """
        self._my_view.SetProj(V3d_Xpos)
    ...
    def view_left(self):
        ...
        :return: None.
        """
        self._my_view.SetProj(V3d_Yneg)
    ...
    def view_right(self):
        ...
        :return: None.
        """
        self._my_view.SetProj(V3d_Ypos)
